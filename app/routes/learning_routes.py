...
router = APIRouter(tags=["Learning System"])
...
def learning_stats():
    return learning_engine.get_agent_stats()
...
@router.get("/learning/best-agent")
def best_agent():
...
def leaderboard():
    return learning_engine.leaderboard()
...
def system_stats():
    return learning_engine.system_stats()
