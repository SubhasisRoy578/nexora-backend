"""
Nexora AI — Agents Router
Exposes endpoints for running single agents, CrewAI crews, and listing agent history.
"""
...
from app.models.agent import AgentRun, AgentRunStatus, AgentTool
from app.models.user import User
from app.schemas.schemas import AgentRunRequest, AgentRunResponse, AgentRunListResponse
from app.services.agents.agent_orchestrator import orchestrator, crew_system
